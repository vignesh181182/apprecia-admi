...
const SEED_COMPANIES: SeedSpec[] = [
  ...
  },
  {
    ...
    adminName: "Aisha Okafor",
    adminEmail: "aisha@umbrellahealth.com",
    adminDesignation: "People Lead",
    adminDepartment: "People Ops",
  ...
  },
  {
    ...
    adminName: "Natalie Brooks",
    adminEmail: "natalie@stark.io",
    adminDesignation: "HRBP",
    adminDepartment: "People Ops",
  ...
  },
  {
    ...
    adminEmail: "emma@wayne.co",
    adminDesignation: "Head of Talent",
    adminDepartment: "People Ops",
    phone: "+1 (213) 555-0177",
    address: "1007 Mountain Dr, Gotham, NY 10001",
    products: { appreciation: true, rnr: true },
    state: "in-setup",
    daysAgo: 4,
    appreciationPolicy: {
      ...
      pointValue: { points: 100, amount: 100 },
      window: { mode: "always" },
      approval: { required: true, approverLevel: "direct-manager" },
    },
  },
  {
    companyName: "Hooli Cloud",
    adminName: "Liam Patel",
    adminEmail: "liam@hooli.dev",
    adminDesignation: "People Ops Manager",
    adminDepartment: "People Ops",
    phone: "+1 (408) 555-0190",
    address: "1 Hacker Way, Palo Alto, CA 94301",
    products: { appreciation: true, rnr: false },
    state: "in-setup",
    daysAgo: 6,
    appreciationPolicy: {
      monetaryEnabled: true,
      pointValue: { points: 100, amount: 75 },
      window: { mode: "always" },
      approval: { required: false, approverLevel: "direct-manager" },
    },
  },
