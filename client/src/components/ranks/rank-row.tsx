...
export function RankRow({ entry }: { entry: LeaderboardEntry }) {
  return (
    <div className="flex items-center gap-3 py-3">
      <span className="w-7 h-7 rounded-full bg-muted text-muted-foreground text-xs font-mobile font-semibold flex items-center justify-center shrink-0">
        {entry.rank}
      </span>
      <img
        src={entry.avatar}
      ...
      <p className="font-mobile font-semibold text-foreground shrink-0">
        {entry.points}{" "}
