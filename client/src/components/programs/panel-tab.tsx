    ...
    return (
      <div className={cn("space-y-3", variant === "web" && "pt-3")}>
        <div className="bg-white rounded-2xl border border-border p-6 text-center">
          ...
          <p className="text-sm font-mobile font-semibold text-foreground">
          ...
          <button
            type="button"
            className="inline-flex items-center gap-1.5 h-9 px-4 rounded-full bg-primary hover:bg-primary/90 text-white text-sm font-mobile font-semibold transition-colors"
          >
    ...
    <div className={cn("space-y-4", variant === "web" && "pt-3")}>
      <div className="bg-white rounded-2xl border border-border p-4 md:p-5">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <p className="font-mobile font-semibold text-foreground text-sm">
              ...
              {lead && (
                <span className="text-muted-foreground font-normal"> · led by {lead.name}</span>
              )}
            </p>
        ...
        <div className="mt-4 pt-4 border-t border-border">
          <div className="flex items-center justify-between text-xs mb-1.5">
            <span className="text-muted-foreground">Overall review progress</span>
            <span className="font-mobile font-semibold text-foreground tabular-nums">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between px-1">
          <p className="text-xs font-mobile font-semibold text-muted-foreground uppercase tracking-wide">
            Panel members
          </p>
          <button
            type="button"
            className="inline-flex items-center gap-1 text-xs font-mobile font-semibold text-primary hover:text-primary/90 transition-colors"
          >
            <UserPlus className="w-3.5 h-3.5" />
            Add member
          </button>
...
function PanelMemberCard({
  ...
  return (
    <div className="bg-white rounded-2xl border border-border p-4 hover:border-border transition-colors">
      <div className="flex items-start gap-3">
        <img
          src={member.avatar}
          alt=""
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 flex-wrap">
            <p className="font-mobile font-semibold text-foreground text-sm truncate">
              {member.name}
            </p>
            {member.lead && (
              <span className="inline-flex items-center gap-1 rounded-full bg-primary/10 border border-primary/15 px-2 py-0.5 text-[10px] font-mobile font-semibold text-primary uppercase tracking-wide">
          ...
          <p className="text-[11px] text-muted-foreground mt-0.5 truncate">{member.department}</p>
        </div>
      </div>
      ...
      <div className="mt-3 pt-3 border-t border-border">
        <div className="flex items-center justify-between text-xs mb-1">
          ...
          <span className="inline-flex items-center gap-1.5">
            ...
            {allDone && (
              <span className="inline-flex items-center gap-0.5 text-success text-[10px] font-mobile font-semibold uppercase tracking-wide">
