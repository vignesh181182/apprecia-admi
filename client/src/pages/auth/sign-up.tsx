          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="last-name" className="text-sm font-normal text-gray-700">
                    Last Name
                  </Label>
                  <Input
                    id="last-name"
              ...
              <div className="space-y-2">
                <Label htmlFor="signup-email" className="text-sm font-normal text-gray-700">
                  Email
                </Label>
                <Input
                  id="signup-email"
              ...
              <div className="space-y-2">
                <Label htmlFor="signup-password" className="text-sm font-normal text-gray-700">
                  Password
                </Label>
                <Input
                  id="signup-password"
