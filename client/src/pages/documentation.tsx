    ...
    <div className="relative bg-stone-900 rounded-lg p-3 sm:p-4 overflow-x-auto">
      <div className="flex justify-between items-center mb-2">
        ...
        <Button
          ...
          className="text-muted-foreground hover:text-white p-1 min-w-0"
        >
          {copiedCode === id ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
        </Button>
      </div>
      <pre className="text-muted-foreground text-xs sm:text-sm overflow-x-auto">
...
cd material-shadcn`} 
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-2">Create a .env file in the root directory:</p>
            <CodeBlock 
...
NODE_ENV="development"`} 
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-2">
              The application will be available at <code className="bg-muted px-1 rounded">http://localhost:5000</code>
            </p>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="border border-border bg-white">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-foreground">Technology Stack</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border border-border bg-white">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-foreground">Project Structure</CardTitle>
        </CardHeader>
        <CardContent>
          <CodeBlock 
            code={`project-root/
...
└── drizzle.config.ts       # Database configuration`}
      ...
      <Card className="border border-border bg-white">
        <CardHeader>
          <CardTitle className="text-xl font-bold text-foreground">Build & Deployment</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div>
            <h4 className="font-semibold text-foreground mb-2">Production Build</h4>
            <CodeBlock code="npm run build" language="bash" id="prod-build" />
          </div>
          
          <div>
            <h4 className="font-semibold text-foreground mb-2">Start Production Server</h4>
            <CodeBlock code="npm start" language="bash" id="start-prod" />
          </div>
          
          <div>
            <h4 className="font-semibold text-foreground mb-2">Database Operations</h4>
            <CodeBlock 
